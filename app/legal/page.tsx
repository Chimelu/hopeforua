  ...
  return (
    <div className="min-h-screen bg-blue-900 py-12 relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Privacy Policy */}
        <section className="bg-blue-800/60 backdrop-blur-sm rounded-lg shadow-lg p-8 mb-8 border border-blue-700/50">
          <h2 className="text-3xl font-bold text-white mb-6">Privacy Policy</h2>
          <div className="prose max-w-none space-y-4 text-blue-100">
            ...
            <div>
              ...
              <p>
                HopeForUA collects information that you provide directly to us when you make a donation, 
        ...
        <section className="bg-blue-800/60 backdrop-blur-sm rounded-lg shadow-lg p-8 mb-8 border border-blue-700/50">
          ...
          <div className="prose max-w-none space-y-4 text-blue-100">
            ...
            <div>
              ...
              <p>
                By accessing and using the HopeForUA website, you accept and agree to be bound by these Terms of Service. 
            ...
            <div>
              ...
              <p>
                All content on this website, including text, graphics, logos, and images, is the property of HopeForUA 
            ...
            <div>
              ...
              <p>
                HopeForUA shall not be liable for any indirect, incidental, special, or consequential damages arising from 
        ...
        <section className="bg-blue-800/60 backdrop-blur-sm border border-blue-700/50 rounded-lg p-8 text-center">
