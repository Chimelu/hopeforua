...
export default function BlogPage() {
  return (
    <div className="min-h-screen bg-blue-900 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogPosts.map((post) => (
              <article
                key={post.id}
                className="bg-blue-800/60 backdrop-blur-sm rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow border border-blue-700/50"
              >
      ...
      {/* Newsletter Signup */}
      <section className="py-12 bg-blue-800/40 backdrop-blur-sm relative">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <form className="max-w-md mx-auto flex gap-2">
            <input
              ...
              className="flex-1 px-4 py-3 bg-white/90 border-2 border-blue-600 rounded-lg focus:border-yellow-400 focus:outline-none text-gray-900"
              required
            />
            <button
              type="submit"
