    ...
    <div className="min-h-screen bg-gray-50">
                ...
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <Link
                      ...
                      className="text-blue-600 hover:text-blue-700 font-semibold text-center"
                    >
                      View Online →
                    </Link>
                  </div>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            href="/donate"
            className="inline-block bg-yellow-400 hover:bg-yellow-500 text-gray-900 px-8 py-4 font-bold text-lg uppercase tracking-wide transition-colors shadow-lg"
          >
            Donate Now
          </Link>
        </div>
