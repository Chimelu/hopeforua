...
export default function ReportsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-12 bg-white border-b-4 border-blue-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-lg text-gray-700">
            <strong>Efficiency and Transparency:</strong> HopeForUA provides fund distribution reports 
                  ...
                  <div className="md:col-span-2 p-8">
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <Link
                        ...
                        className="bg-blue-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-blue-700 transition-colors text-sm whitespace-nowrap ml-4"
                      >
                        Donate
                      </Link>
                    </div>
