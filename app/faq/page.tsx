...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'Yes, HopeForUA is a registered charitable organization, and all donations are tax-deductible. You will receive a receipt via email for your records. Please consult with a tax professional for specific advice regarding your tax situation.',
  },
  {
  ...
  },
  {
    ...
    answer: 'You can update your donation information by contacting our support team at support@hopeforua.org or by calling us at +1 (555) 123-4567. We can help you change your payment method, update your contact information, or modify your recurring donation schedule.',
  },
  {
    question: 'What types of support does HopeForUA provide?',
    answer: 'HopeForUA provides a wide range of support including financial assistance, essential resources, community programs, and educational initiatives. Our focus areas include emergency relief, long-term community development, and providing access to essential services.',
  },
  {
    question: 'How can I volunteer with HopeForUA?',
...
export default function FAQPage() {
  ...
  return (
    <div className="min-h-screen bg-blue-900 py-12 relative overflow-hidden">
      {/* Decorative Elements */}
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-blue-100">
            Find answers to common questions about HopeForUA and our work
          </p>
        </div>
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="bg-blue-800/60 backdrop-blur-sm rounded-lg shadow-lg overflow-hidden border border-blue-700/50"
            >
              <button
                onClick={() => toggleFAQ(index)}
                className="w-full px-6 py-5 text-left flex justify-between items-center hover:bg-blue-700/50 transition-colors focus:outline-none"
              ...
              >
                ...
                <svg
                  className={`w-6 h-6 text-yellow-400 flex-shrink-0 transform transition-transform ${
        ...
        <div className="mt-12 bg-blue-800/60 backdrop-blur-sm border border-blue-700/50 rounded-lg p-8 text-center">
