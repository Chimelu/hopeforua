      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="lg:col-span-1 space-y-6">
            {/* Email Card */}
            <div className="bg-blue-800/60 backdrop-blur-sm rounded-xl shadow-xl p-6 border border-blue-700/50 hover:shadow-2xl transition-all">
          ...
          {/* Contact Form */}
          <div className="lg:col-span-2 bg-blue-800/60 backdrop-blur-sm rounded-xl shadow-xl p-8 border border-blue-700/50">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white/90 border-2 border-blue-600 rounded-lg focus:border-yellow-400 focus:outline-none transition-colors text-gray-900"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 bg-white/90 border-2 border-blue-600 rounded-lg focus:border-yellow-400 focus:outline-none transition-colors resize-none text-gray-900"
              ...
              <button
                type="submit"
                className="w-full bg-yellow-400 hover:bg-yellow-500 text-gray-900 py-4 rounded-lg font-bold text-lg transition-all shadow-lg hover:shadow-xl transform hover:scale-105"
              >
                Send Message
              </button>
            </form>
        ...
        {/* Image Section */}
        <div className="mt-12 relative h-64 md:h-80 rounded-xl overflow-hidden shadow-2xl border-2 border-blue-700">
          <Image
